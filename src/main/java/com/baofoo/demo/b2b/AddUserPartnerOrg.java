...
public class AddUserPartnerOrg {
	public static void main(String[] args) throws Exception {
		...
		dataContentMap.put("enName", "Global Interconnection Limited");
		dataContentMap.put("address", "中国上海");
		
		GepUtils.sendRequest(url, dataContentMap, null, true);
		//result解密信息：{"address":"中国上海","countryCode":"CHN","enName":"Global Interconnection Limited","name":"全球互联有限公司","partnerNo":2407151336000002604,"partnerType":3}
